...
kernel: $(SRC_C) init
	x86_64-w64-mingw32-gcc -O0 -ffreestanding -nostdlib -Wl,--image-base,0x200000,-e,ASMEntryPoint,--section-alignment,0x1000,--file-alignment,0x1000,--subsystem,native,-T,link_script.ld kernel/divide_by_zero.o kernel/isrs.o kernel/pic.c kernel/console_controller.c kernel/pio.c kernel/edit_mode_controller.c kernel/process_manager.c kernel/keyboard.c kernel/main.c kernel/timer.c kernel/string.c kernel/logging.c kernel/screen.c kernel/idt.c kernel/isr.c -o bin/kernel.exe
